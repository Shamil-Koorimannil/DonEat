                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildReadOnlyField(widget.donation.foodName ?? 'Not provided'),
                      const SizedBox(height: 20),
                      const Text("Pickup location",
                          style: TextStyle(fontSize: 14, color: Colors.black87)),
                      const SizedBox(height: 10),
                      _buildLocationField(widget.donation.location ?? 'Not provided'),
                      const SizedBox(height: 20),
                      const Text("Pickup Date",
                          style: TextStyle(fontSize: 14, color: Colors.black87)),
                      const SizedBox(height: 10),
                      _buildReadOnlyField(widget.donation.date ?? 'Not provided'),
                      const SizedBox(height: 20),
                      const Text("Pickup Time",
                          style: TextStyle(fontSize: 14, color: Colors.black87)),
                      const SizedBox(height: 10),
                      _buildReadOnlyField(widget.donation.time ?? 'Not provided'),
                      const SizedBox(height: 20),
                      const Text("Contact number",
                          style: TextStyle(fontSize: 14, color: Colors.black87)),
                      const SizedBox(height: 10),
                      _buildReadOnlyField(widget.donation.contact ?? 'Not provided'),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Slider(
                              value: (widget.donation.quantity ?? 0).toDouble(),
                              min: 5,
                              max: 300,
                              divisions: 295,
                      ...
                      const SizedBox(height: 30),
                      if (widget.donation.status != KeysConstant.completedStatus)
                        Column(
                          children: [
                            SizedBox(
